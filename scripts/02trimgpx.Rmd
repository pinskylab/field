...
Save the imported tracks as shapefiles in the Trackfiles directory.  Remove the non-shapefile track layers.

Click on Vector > Data Management Tools > Merge Shapefiles to One and select the current year merged track plus the new tracks that have been added today.  Save the file as a different name.
