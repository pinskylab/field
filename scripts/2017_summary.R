...
rm(rep_tag)
# add dive info
same_seas_recap <- left_join(same_seas_recap, dive)
...
# what is the size structure of the clownfish at Palanas in 2017?
library(ggplot2)
# ggplot(fish, aes(size)) + geom_histogram() # doesn't work because it says it is not continuous

ggplot(fish, aes(size)) + geom_bar()
